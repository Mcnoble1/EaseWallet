...
const addDropoffAreaLandmarkInstance = () => {
  ...
  const handleInputChange = (e: ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    } else if (name === 'driver' || name === 'company' || name === 'vehicle' || name === 'pickuparea' || name === 'dropoffarea' || name === 'dropofflandmark') {
  ...
  const handleDelete = (vehicleId: number) => {
    ...
    axios(config)
      .then(function (response) {
        ...
        setVehiclesData((prevVehicles) => [...prevVehicles, response.data.data]);
      ...
      <div className="flex gap-2">
        ...
        {/* <div className="relative">
          ...
          {filterDropdownVisible && (
            <div className="absolute top-12 left-0 bg-boxdark border border-stroke rounded-b-sm shadow-lg ">
            <ul className="py-2">
                {vehiclesData.map((vehicle) => (
                  <li
                    key={vehicle._id}
      ...
      <div className="flex flex-col overflow-x-auto">
        <table className="min-w-full">
          ...
          <tr className="border-b border-strokedark ">
              ...
              <th className="p-2.5 xl:p-5 text-sm font-medium text-left uppercase">Company Name</th>
              <th className="p-2.5 xl:p-5 text-sm font-medium text-left uppercase">Driver</th>
              <th className="p-2.5 xl:p-5 text-sm font-medium text-left uppercase">Phone Number</th>
              {/* <th className="p-2.5 xl:p-5 text-sm font-medium text-left uppercase">Vehicle Type</th> */}
          ...
          <tbody>
            ...
            {vehiclesData.map((vehicle, index) => (
              <tr key={vehicle._id} className={`border-b border-strokedark ${index === 0 ? 'rounded-t-sm' : ''}`}>
                ...
                {/* <td className="p-2.5 xl:p-5 ">{vehicle.vehicle.vehicleName}</td> */}
                <td className="p-2.5 xl:p-5">
                  ...
                  <button
                    ...
                    {popupOpenMap[vehicle._id] && (
                            <div
                              ref={popup}
                              className="fixed inset-0 flex text-white items-center justify-center z-50 bg-tertiary bg-tertiary/90"
                            >
                              <div
