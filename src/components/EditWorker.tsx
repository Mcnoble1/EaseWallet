...
import WorkersTable from './CustomersTable';
  ...
  return (
    <div className="dark:bg-boxdark-2 dark:text-bodydark">
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
          ...
          <main>
            ...
            className="mb-6 flex flex-row gap-3 sm:flex-row sm:items-center sm:justify-between">
          <Breadcrumb pageName="Workers" />
          <nav className="inline-flex items-center justify-center rounded-full bg-primary py-3 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10">
              Add Worker
          </nav>
        </div>
      ...
      {popupOpen && (
        ...
        >
          <div className="bg-white lg:mt-15 lg:w-1/2 rounded-lg pt-3 px-4 shadow-md"
          ...
          <div className='flex flex-row justify-between'>
              ...
              <div className="flex justify-end">
                <button
                  onClick={() => setPopupOpen(false)} // This function should close the popup
            ...
            <form>
                    ...
                    <label className="mb-2.5 block text-black dark:text-white">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-center justify-center space-y-3">
                            ...
                            <p>
                              <span className="text-primary">Worker Image</span> or
                              drag and drop
                            </p>
              ...
              <button
                  type="button"
                  onClick={() => setPopupOpen(false)} // Close popup on second page
                  className="mr-5 mb-5 inline-flex items-center justify-center gap-2.5 rounded-full bg-primary py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10"
                >
                  <span>
                        <svg
