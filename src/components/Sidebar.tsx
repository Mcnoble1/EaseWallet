...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen flex-col overflow-y-hidden bg-gradient-to-b from-[#1c1e27] from-70% via-[#1B3069] via-79% to-[#1A4CD3] to-99% duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
