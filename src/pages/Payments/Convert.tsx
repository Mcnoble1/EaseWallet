...
import { showSuccessNotification, showErrorNotification, closePopup, validateRequiredFields, letterRegex } from '../../utils/helpers';
import { fetchCategories, createCategory, createService } from '../../api/configurationApi';
...
const Categories: React.FC = () => {
  ...
  const handleAddCategory = (e: FormEvent) => {
    ...
    const url = 'https://madad.onrender.com/api/admin/configuration/create-category';
  ...
  const handleAddService = async (e: FormEvent) => {
    ...
    formDataToSend.append('category', serviceFormData.category);
    formDataToSend.append('image', serviceFormData.image!); // Ensure image is not null here
  
    const url = 'https://madad.onrender.com/api/admin/configuration/create-service';
    handleSubmit(url, formDataToSend, setServicePopupOpen, 'Service created successfully!',);
          ...
          <main>
            <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
              <div className="mb-6 flex flex-row gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                className="inline-flex items-center justify-center rounded-full bg-secondary py-3 px-5 text-center font-medium text-white hover:bg-opacity-90 lg:px-5 xl:px-5">
                  Add Service
              </button>
                </div>   
              </div>
              ...
              {categoryPopupOpen && (
                ...
                >
                  ...
                  >   
                  <div className="bg-tertiary lg:w-full text-white first-letter:rounded-lg p-4 shadow-md">
                    ...
                    <div className= "rounded-sm bg-tertiary text-white">
                        <div className="flex flex-col gap-5.5">
                          ...
                          <label className="mb-2.5 block text-white ">
                            ...
                            <div className={`relative ${formData.name ? 'bg-light-blue text-black' : ''}`}>
                            <input
                              type="text"
                              name="name"
                              value={formData.name}
              ...
              {servicePopupOpen && (
                ...
                >
                   <div
                    ...
                    style={{ maxHeight: 'calc(100vh - 200px)', overflowY: 'scroll' }}
                  >    
                  <div className="bg-tertiary lg:w-full rounded-lg p-4 shadow-md">
                    <div className="flex flex-row justify-between">
                      <h2 className="text-xl text-white font-semibold mb-4">Add Service</h2>
                      <div className="flex justify-end">
                        <button
                        ...
                        <div className="flex flex-col gap-5.5">
                          ...
                          <div>
                            <label className="mb-3 block dark:text-white">
                             ...
                             <div className={`relative ${serviceFormData.name ? 'bg-light-blu' : ''}`}>
                            <input
                              type="text"
                              name="name"
              ...
              <div className="flex flex-col gap-10">
                {isTableView ? <AllCategoriesTable /> : <AllCategories />}
              </div>
              </div>
          </main>
        </div>
