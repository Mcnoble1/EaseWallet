          ...
          <main>
            <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
              ...
              {popupOpen && (
                ...
                >
                  <div
                    className="bg-tertiary lg:mt-15 lg:w-1/2 rounded-lg pt-3 px-4 shadow-md border border-stroke"
                    style={{ maxHeight: 'calc(100vh - 200px)', overflowY: "scroll" }}
                  >
                    <div className="flex flex-row justify-between">
                      <h2 className="text-xl font-semibold mb-4 text-white">Add Customer</h2>
                    ...
                    <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                      ...
                      <div className="w-full xl:w-1/2">
                      <label className="mb-2.5 block dark:text-white">Languages</label>
                    ...
                    <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        <div className="w-full xl:w-1/2">
                          <label className="mb-2.5 block dark:text-white">Home Area</label>
                        ...
                        <div className="w-full xl:w-1/2">
                          <label className="mb-2.5 block dark:text-white">Home Block</label>
